...
🔗 [GitHub Repo](https://github.com/1Kelv/AgileFlow)

---

### 📊 [NextGen AI Résumé Analyser](https://g3tsfvzt8zlfbxsttxk5bh.streamlit.app/)  
Explains AI résumé scoring using **SHAP**, **LIME**, and **Fairness Audit**.  
🧠 *Focus:* Model transparency and explainable AI.  
🔗 [GitHub Repo](https://github.com/1Kelv/nextgen-ai-resume-analyser)

---

### 🍌 [Banana Game](https://api-banana-game.netlify.app/)  
Interactive browser game that fetches banana-themed challenges via API.  
🎮 *Stack:* HTML, CSS, JavaScript, Express.js, MySQL.  
🔗 [GitHub Repo](https://github.com/1Kelv/banana-game)

---

### 🌦 [Weather Forecast App](https://weather-app-kelvin.netlify.app/)  
Real-time weather updates with a sleek, responsive interface using **OpenWeatherMap API**.  
🔗 [GitHub Repo](https://github.com/1Kelv/weather-app)
...
- 📜 **Certifications:**  
  ...
  - [Code Institute 5-Day Coding Challenge](https://kelvino-dev.netlify.app/)
...
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/1Kelv)
